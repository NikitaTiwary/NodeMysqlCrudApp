...
describe('base.controller spec', () => {
  ...
  const mockNext = (err?: any): void => err;
  ...
  describe('"statistics()"', () => {
    ...
    beforeEach(() => {
      ...
      mockModel.countDocuments = jest.fn().mockImplementation((callback) => callback(error, nrOfDocuments));
    });
  ...
  describe('"findById()"', () => {
    ...
    beforeEach(() => {
      ...
      mockModel.findById = jest.fn().mockImplementation((_id) => ({
        populate: function (foreignProperties: IPopulate[]): IMockModel {
          foreignProperties.forEach(foreignProperty => {
            _model[foreignProperty.path] = foreignProperty.select;
          });
          return this;
        },
        exec: (callback: Function): void => callback(error, _model),
      }));
    });
  ...
  describe('"index()"', () => {
    ...
    beforeEach(() => {
      ...
      mockModel.find = jest.fn((q: any): any => {
        ...
        const mockFind = {
          ...
          exec: (callback: Function): void => callback(error, data),
        };
    ...
    it('should return error, if error occurs', () => {
      ...
      controller.index(mockRequest, mockResponse, (err: any) => {
  ...
  describe('"create()"', () => {
    ...
    it('should return next error, if not duplicate nor validation error', () => {
      ...
      controller.create(mockRequest, mockResponse, (err: any) => {
        expect(err).toEqual(error);
      });
  ...
  describe('"update()"', () => {
    ...
    it('should return next error, if its not a validation error', () => {
      ...
      controller.update(mockRequest, mockResponse, (err: any) => {
        expect(err).toEqual(error);
      });
  ...
  describe('"populateMeta()"', () => {
    ...
    beforeEach(() => {
      ...
      mockModel.countDocuments =
        jest.fn().mockImplementation((_query, callback: Function) => callback(error, nrOfDocuments));
    });
    ...
    it('should return next, if error occurs', () => {
      ...
      controller.populateMeta(mockRequest, mockResponse, (err: any) => {
        expect(err).toEqual(error);
      });
    });
  });
