...
<head>
    <title>Code coverage report for src/base.controller.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> base.controller.ts</h1>
        <div class='clearfix'>
...
&nbsp;
  ...
  public parseSort(sort: string | null = <span class="branch-0 cbranch-no" title="branch not covered" >null)</span>: Record&lt;string, -1 | 1&gt; | null {
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (Object.keys(parsedSort).length === 0) {
<span class="cstat-no" title="statement not covered" >        parsedSort['date'] = -1;</span>
      }
&nbsp;
      return parsedSort;
    } else {
...
&nbsp;
    return isNaN(_value) ? <span class="branch-0 cbranch-no" title="branch not covered" >_default </span>: _value;
  }
&nbsp;
&nbsp;
  public parseQuery(query: IApiParsedQuery): IApiParsedQuery {
    return {
      ...
      populate: query.populate
        ? <span class="branch-0 cbranch-no" title="branch not covered" >[ ...query.populate ]</span>
        : [],
      deleted: !!query.deleted,
      select: typeof query.select === 'string'
        ? <span class="branch-0 cbranch-no" title="branch not covered" >query.select</span>
        : {
          ...query.select,
        },
      total: 0,
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Mon Jul 19 2021 20:42:10 GMT+0200 (Central European Summer Time)
            </div>
        </div>
